...
def get_dataset(i,index,mapping_entities,mapping_properties, train_pre_path,train_materialized_path,ontology_materialized_path, batch_size,max_e,max_p):
    X_train=[]
    Y_train=[]
    ...
    train = torch.utils.data.TensorDataset(train_x,train_x)
